...
import com.twilio.verify.api.FRIENDLY_NAME_KEY
  ...
  fun `Verify a factor with valid params should return a factor`() {
    ...
    val response =
      JSONObject()
        ...
        .put(FRIENDLY_NAME_KEY, "factor name")
        .put(ACCOUNT_SID_KEY, "accountSid123")
        .put(SERVICE_SID_KEY, "serviceSid")
        .put(STATUS_KEY, FactorStatus.Unverified.value)
