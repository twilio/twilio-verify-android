//[verify](../../../../index.md)/[com.twilio.verify](../../../index.md)/[TwilioVerifyException](../../index.md)/[ErrorCode](../index.md)/[AuthenticationTokenError](index.md)



# AuthenticationTokenError  
 [androidJvm] [AuthenticationTokenError](index.md)("{$AUTHENTICATION_TOKEN_CODE} Exception while generating token")  
...
|  Name|  Summary| 
|---|---|
| [message](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.AuthenticationTokenError/message/#/PointingToDeclaration/)|  [androidJvm] override val [message](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.AuthenticationTokenError/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [name](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.AuthenticationTokenError/name/#/PointingToDeclaration/)|  [androidJvm] override val [name](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.AuthenticationTokenError/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.AuthenticationTokenError/ordinal/#/PointingToDeclaration/)|  [androidJvm] override val [ordinal](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.AuthenticationTokenError/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
