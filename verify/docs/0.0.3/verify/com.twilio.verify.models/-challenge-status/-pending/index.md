...
title: Pending -
---
//[verify](../../../index.md)/[com.twilio.verify.models](../../index.md)/[ChallengeStatus](../index.md)/[Pending](index.md)



# Pending  
 [androidJvm] The Challenge is waiting to be approved or denied by the user  
  
[Pending](index.md)("pending")  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#com.twilio.verify.models/ChallengeStatus.Pending/name/#/PointingToDeclaration/)|  [androidJvm] override val [name](index.md#com.twilio.verify.models/ChallengeStatus.Pending/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#com.twilio.verify.models/ChallengeStatus.Pending/ordinal/#/PointingToDeclaration/)|  [androidJvm] override val [ordinal](index.md#com.twilio.verify.models/ChallengeStatus.Pending/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [value](index.md#com.twilio.verify.models/ChallengeStatus.Pending/value/#/PointingToDeclaration/)|  [androidJvm] override val [value](index.md#com.twilio.verify.models/ChallengeStatus.Pending/value/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
