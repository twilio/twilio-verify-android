//[verify](../../index.md)/[com.twilio.verify.data](../index.md)/[StorageException](index.md)



# StorageException  
 [androidJvm] class [StorageException](index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [Exception](https://developer.android.com/reference/java/lang/Exception.html)   
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#com.twilio.verify.data/StorageException/cause/#/PointingToDeclaration/)|  [androidJvm] open override val [cause](index.md#com.twilio.verify.data/StorageException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#com.twilio.verify.data/StorageException/message/#/PointingToDeclaration/)|  [androidJvm] open override val [message](index.md#com.twilio.verify.data/StorageException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
