//[verify](../../../index.md)/[com.twilio.verify.models](../../index.md)/[ChallengeStatus](../index.md)/[Expired](index.md)



# Expired  
 [androidJvm] The Challenge expired and can't no longer be approved or denied by the user  
  
[Expired](index.md)("expired")  
...
|  Name|  Summary| 
|---|---|
| [name](index.md#com.twilio.verify.models/ChallengeStatus.Expired/name/#/PointingToDeclaration/)|  [androidJvm] override val [name](index.md#com.twilio.verify.models/ChallengeStatus.Expired/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#com.twilio.verify.models/ChallengeStatus.Expired/ordinal/#/PointingToDeclaration/)|  [androidJvm] override val [ordinal](index.md#com.twilio.verify.models/ChallengeStatus.Expired/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
| [value](index.md#com.twilio.verify.models/ChallengeStatus.Expired/value/#/PointingToDeclaration/)|  [androidJvm] override val [value](index.md#com.twilio.verify.models/ChallengeStatus.Expired/value/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
