//[verify](../../../../index.md)/[com.twilio.verify](../../../index.md)/[TwilioVerifyException](../../index.md)/[ErrorCode](../index.md)/[MapperError](index.md)



# MapperError  
 [androidJvm] [MapperError](index.md)("{$MAPPER_CODE} Exception while mapping an entity")  
...
|  Name|  Summary| 
|---|---|
| [message](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.MapperError/message/#/PointingToDeclaration/)|  [androidJvm] override val [message](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.MapperError/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [name](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.MapperError/name/#/PointingToDeclaration/)|  [androidJvm] override val [name](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.MapperError/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.MapperError/ordinal/#/PointingToDeclaration/)|  [androidJvm] override val [ordinal](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.MapperError/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
