//[verify](../../../../index.md)/[com.twilio.verify](../../../index.md)/[TwilioVerifyException](../../index.md)/[ErrorCode](../index.md)/[NetworkError](index.md)



# NetworkError  
 [androidJvm] [NetworkError](index.md)("{$NETWORK_CODE} Exception while calling the API")  
...
|  Name|  Summary| 
|---|---|
| [message](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.NetworkError/message/#/PointingToDeclaration/)|  [androidJvm] override val [message](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.NetworkError/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [name](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.NetworkError/name/#/PointingToDeclaration/)|  [androidJvm] override val [name](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.NetworkError/name/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>
| [ordinal](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.NetworkError/ordinal/#/PointingToDeclaration/)|  [androidJvm] override val [ordinal](index.md#com.twilio.verify/TwilioVerifyException.ErrorCode.NetworkError/ordinal/#/PointingToDeclaration/): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)   <br>
